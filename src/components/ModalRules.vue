...
function nextStep(): number {
  return currentStep.value === 1 ? currentStep.value++ : currentStep.value--
}
</script>
  ...
  <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80 z-20">
    <div class="relative flex items-center mt-5 sm:mt-10">
      <button
        ...
        @click="nextStep"
        class="absolute left-[-35px] sm:left-[-45px] top-1/2 -translate-y-1/2 cursor-pointer hover:opacity-70 disabled:opacity-50"
      >
        <font-awesome-icon icon="angles-left" size="lg" sm:size="2xl" style="color: #7651e6" />
      </button>
      ...
      >
        ...
        >
          <font-awesome-icon icon="circle-xmark" size="lg" sm:size="2xl" style="color: #7651e6" />
        </button>
      ...
      <button
        ...
        @click="nextStep"
        class="absolute right-[-35px] sm:right-[-45px] top-1/2 -translate-y-1/2 cursor-pointer hover:opacity-70 disabled:opacity-50"
      >
        <font-awesome-icon icon="angles-right" size="lg" sm:size="2xl" style="color: #7651e6" />
      </button>
    </div>
  </div>
</template>
